 ...
 *****************************************************************/
 void SYSTICK_SetTimerMS(u32 TimeMS)
{
	u8 PRESCALER;
 ...
 *                        ERROR_OK  : if the input argument is correct
 *                        ERROR_NOK : if input argument is null
 *
 * Input Argument : pointer to function
 **************************************************************************/
u8 SYSTICK_SetCallBack( void(*Cbf)(void))
{
	u8 Status = ERROR_OK ;
	if(Cbf)
	{
...
void SYSTICK_BusyDelay(u32 TimeMS)
{
	u8 PRESCALER;
